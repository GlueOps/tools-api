...
tools-api is a FastAPI service providing internal REST APIs for GlueOps platform engineers. It manages AWS accounts, cloud storage (MinIO), Proxmox infrastructure (Chisel load balancer nodes), GitHub organization setup, Kubernetes/ArgoCD manifest generation, and alerting integrations (Opsgenie, incident.io).
